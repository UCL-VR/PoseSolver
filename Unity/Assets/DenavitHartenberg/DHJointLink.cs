...
namespace UCL.CASMS.DH
{
    ...
    /// transforms. This does mean that branching is not supported.
    /// </summary>
    [ExecuteInEditMode]
    ...
    {
        [SerializeField]
        public Joint joint; // Holds the Joint Parameters

        [SerializeField]
        private GameObject endpoint; // Holds the Transform at the end of the Link
