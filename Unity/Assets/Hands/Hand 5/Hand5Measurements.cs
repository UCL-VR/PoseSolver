...
public class Hand5Measurements : MonoBehaviour
{
    private Hand5Solver solver;
    ...
    internal class ImuMarkerMeasurement
    {
        ...
        public Hand5Solver solver;
        public Fingers finger;

        public Hand5Solver.PointMeasurement position;
        public Hand5Solver.OrientationMeasurement orientation;
        ...
        public ImuMarkerMeasurement(ImuMarker marker, Hand5Solver solver, Fingers finger)
        {
            this.marker = marker;
            this.solver = solver;
            this.finger = finger;
        ...
        public ImuMarkerMeasurement(ImuMarker marker, Hand5Solver solver)
        {
            this.marker = marker;
            this.solver = solver;
    ...
    private void Awake()
    {
        solver = GetComponent<Hand5Solver>();
    }
